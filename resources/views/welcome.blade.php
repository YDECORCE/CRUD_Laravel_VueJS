            ...
            <div class="flex-center position-ref full-height">
                <div class="content">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="make" required placeholder="Marque" name="make" v-model="newCar.make">
                    </div>
                                        
                    <div class="form-group">
                        <label for="model">Modèle</label>
                        <input type="text" class="form-control" id="model" required placeholder="Modèle" name="model" v-model="newCar.model">
                    </div>
